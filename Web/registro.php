        ...
        <form id="registro" >
          ...
          <fieldset class="clearfix">
            ...
            <div id="contraseña">
              ...
              <p data-toggle="tooltip" data-placement="top" title="Tooltip on top"><span class="fa fa-lock"></span><input type="password" name="clave" id="Regclave"
