...
<body>
    <div class="container">
        <div>
            <div class="middle">
                ...
                <div class="logo">
                    <a href="./Index.php">
                        <svg class="bi" viewBox="0 0 180.12 106.21" viewBox="0 0 180.12 106.21">
                            <path fill="white"
                ...
                <div id="login">
                    ...
                    <form action="./Index.php" method="post">
                        ...
                        <fieldset class="clearfix">
                            ...
                            <p><span class="fa fa-user"></span><input type="text" type="email" name="correo"
    ...
    <!-- <form action="./Index.php" method="post">
        ...
        <div>
            <input type="email" name="correo" id="Logcorreo" placeholder="Correo electronico">
        </div>
        <div>
            <input type="password" name="clave" id="Logclave" placeholder="Contraseña">
        </div>
